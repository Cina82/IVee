...
class adminManageController extends Controller
{
    	...
    	public function index()
    	{
			...
			return view('pages.superadmin.pages.admin',compact('post'));
    	}

    	public function newAdmin()
    	{
    		return view('pages.superadmin.pages.newAdmin');
    	}
        ...
        public function saveAdmin(Request $request)
        {
            ...
            return redirect('createAdminBySuperAdmin');
        }
        public function showAdmin($id)
        {
             $post = User::find($id);
             return view('pages.superadmin.pages.editAdmin',compact('post'));
        }
