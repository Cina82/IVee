    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                @role('admin')
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li {{ Request::is('users', 'users/' . Auth::user()->id, 'users/' . Auth::user()->id . '/edit') ? 'class=active' : null }}>{!! HTML::link(url('/users'), 
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                @if (Auth::guest())
                   <li><a href="{{ route('login') }}">{!! trans('Log In') !!}</a></li>
                    <!-- <li><a href="{{ route('register') }}">{!! trans('Sign Up') !!}</a> -->
                    <!-- <li><a href="choose-account">{!! trans('Sign Up') !!}</a>
                    </li>
 -->
                @else
                    <li class="dropdown">
