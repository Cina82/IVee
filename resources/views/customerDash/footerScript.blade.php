 <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js">
 ...
 </script><script src="{{URL::to('public/assets/jquery.browser-c000434a.js')}}">
    ...
    <script src="{{ URL::To('public/assets/core-673e97f4.js') }}"></script>
    <script src="{{ URL::To('public/assets/core.es6-2386888a.js') }}"></script>
    <script src="{{ URL::To('public/assets/homepage-sticky-header.es6-607dc99c.js')}}">
    </script>
    <script src="{{ URL::To('public/assets/category-carousel-ng.es6-988eb0a4.js') }}">
    </script>
    <script src="{{ URL::To('public/assets/request-form-ng.es6-e7ec4c2d.js') }}">
    </script>
