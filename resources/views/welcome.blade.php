...
<div class="Homepage">
   <div viewport-element="hero">
      <hero
         ...
         uses-densities
         above-md="{
         '1x': '{{URL::to('public/assets/img/home-hero-lg-1x-c459a9bc.jpg')}}
         ',
         '2x': '{{URL::to('public/assets/img/home-hero-lg-1x-c459a9bc.jpg')}}
         '
         }"
         above-sm-below-md="{
         '1x': ' {{URL::to('public/assets/img/home-hero-lg-1x-c459a9bc.jpg')}}
         ...
         below-sm="{ {{URL::to('public/assets/img/home-hero-lg-1x-c459a9bc.jpg')}}
         ',
         '2x': ' {{URL::to('public/assets/img/home-hero-lg-1x-c459a9bc.jpg')}}
         '
         }"
...
<!--          <div class="Moments-moment">
   ...
   <about-thumbtack>
      <div class="about-thumbtack">
         <div class="tp-wrap-snap">
            <h2 class="about-thumbtack__heading tp-heading-2">How Thumbtack works</h2>
      ...
      <div class="guarantee-tout">
         <div responsive-if="below-sm"
            ...
            <div class="guarantee-tout__image"
               ...
               uses-densities
               below-sm="{
               '1x': '{{URL::to('public/assets/img/mobile-1x-aaff70a2.jpg')}}',
               '2x': '{{URL::to('public/assets/img/mobile-2x-cc9383f0.jpg')}}'
               }"
               >
            </div>
         </div>
         <div responsive-if="above-sm"
            ...
            <div class="guarantee-tout__image"
               ...
               uses-densities
               above-sm="{
               '1x': '{{URL::to('public/assets/img/desktop-1x-2a11cbc8.jpg')}}',
               '2x': '{{URL::to('public/assets/img/desktop-2x-a267575d.jpg')}}'
               }"
               >
            </div>
         </div>
            ...
            <div class="tp-grid tp-grid--flush">
               <div class="tp-col tp-col--12 tp-col--md-6 tp-col--md-offset-6">
                  <div class="guarantee-tout__box">
                     ...
                     <h3 class="tp-heading-4">Thumbtack Guarantee</h3>
   ...
   <customer-stories>
      <div class="customer-stories">
         <div class="tp-wrap-snap">
            <h2 class="customer-stories__heading tp-heading-2">Customers use Thumbtack to get millions of projects done quickly and easily</h2>
            <div class="tp-grid">
   ...
   <app-upsell
      ...
      <div class="app-upsell"
         ...
         uses-densities
         above-sm="{
         '1x': '{{URL::to('public/assets/img/appupsell-bg-1x-56aa6732.jpg')}}',
         '2x': '{{URL::to('public/assets/img/appupsell-bg-2x-e8c738a7.jpg')}}'
         }"
         below-sm="false">
         <div class="tp-wrap-snap">
            <div class="tp-grid">
            ...
            <div class="tp-grid">
               <div class="tp-col tp-col--12 tp-col--md-8 tp-padding-ends">
                  <a href="#"
                     ...
                     style="background-image: url({{URL::to('public/assets/img/sara-3e60bf01.jpg')}})"
                  ...
                  <div class="tp-grid">
                     <div class="tp-col tp-col--12 tp-padding-ends">
                        <a href="#"
                           ...
                           url({{URL::to('public/assets/img/richard-2d596554.jpg')}})"
                           event-track="home page/clicked pro stories"
                           event-track-on="click"
                           open-youtube-modal
                           youtube-autoplay
                     ...
                     <div class="tp-col tp-col--12 tp-padding-ends">
                        <a href="#"
                           class="testimonial-videos__item"
                           style="background-image:
                           url({{URL::to('public/assets/img/katie-cd576b4e.jpg')}})"
                           event-track="home page/clicked pro stories"
                           event-track-on="click"
                           open-youtube-modal
                           youtube-autoplay
               ...
               <div class="tp-col tp-col--12 tp-col--md-4 tp-padding-ends">
                  <a href="#"
                     class="testimonial-videos__item"
                     style="background-image:
                     url({{URL::to('public/assets/img/bonnie-86155b0d.jpg')}})"
                     event-track="home page/clicked pro stories"
                     event-track-on="click"
                     open-youtube-modal
                     youtube-autoplay
               ...
               <div class="tp-col tp-col--12 tp-col--md-4 tp-padding-ends">
                  <a href="#"
                     class="testimonial-videos__item"
                     style="background-image:
                     url({{URL::to('public/assets/img/eric-7d68e969.jpg')}})"
                     event-track="home page/clicked pro stories"
                     event-track-on="click"
                     open-youtube-modal
                     youtube-autoplay
   ...
   <homepage-sticky-header
      fallback-logo="{{ URL::to('public/assets/img/Logo/LogoOrange.png') }}"
