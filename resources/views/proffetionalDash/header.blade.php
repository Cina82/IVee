...
<div class="glorious-header GlobalHeader" data-section="header">
    <div class="wrapper">
        <div class="row header-row">
            ...
            <a class="middle-tab " href="{{URL::to('explore')}}" event-track="dashboard/click explore" event-track-on="click">Index
            </a>
            <a class="middle-tab " href="{{URL::to('explore')}}" event-track="dashboard/click explore" event-track-on="click">Calender
            </a>
            <a class="middle-tab " href="{{URL::to('explore')}}" event-track="dashboard/click explore" event-track-on="click">Services
            </a>
            <a class="middle-tab " href="{{URL::to('explore')}}" event-track="dashboard/click explore" event-track-on="click">Insights
            </a>
            </div>
 ...
 -->
                        <div class="box profile-box" data-section="profile-box" style="display: none;">
                            ...
                            <div class="box-footer profile-box-nav"><a class="GlobalHeader-profileLink" href="{{URL::to('proffetional/profile')}}">
                                                    Profile
                                                </a><a href="/profile/settings">
                                                Settings
                                            </a><a href="{{URL::to('logout')}}">
