...
@section('css')
<link rel="stylesheet" href="{{URL::to('public/assets/explore-v1-3be7845a.css')}}" />
      ...
      <div class="CategoryNavV2  theme-explore ">
         ...
         <div class="page-grid CategoryNavV2-categoryContainer">
            <div class="column-lg-1 column-md-2 column-sm-2 column-xs-6 CategoryNavV2-category">
               <a class="CategoryNavV2-category-link" href="{{URL::to('homeImprovement')}}">
            ...
            <div class="column-lg-1 column-md-2 column-sm-2 column-xs-6 CategoryNavV2-category">
               <a class="CategoryNavV2-category-link" href="{{URL::to('events')}}">
                  <div class="CategoryNavV2-category-link-logo" responsive-if="above-xs" responsive-grid="page">
            ...
            <div class="column-lg-1 column-md-2 column-sm-2 column-xs-6 CategoryNavV2-category">
               <a class="CategoryNavV2-category-link" href="{{URL::to('lessons')}}">
                  <div class="CategoryNavV2-category-link-logo" responsive-if="above-xs" responsive-grid="page">
            ...
            <div class="column-lg-1 column-md-2 column-sm-2 column-xs-6 CategoryNavV2-category">
               <a class="CategoryNavV2-category-link" href="{{URL::to('wellness')}}">
                  <div class="CategoryNavV2-category-link-logo" responsive-if="above-xs" responsive-grid="page">
