...
@section('css')
<link rel="stylesheet" type="text/css" href="{{URL::to('public/assets/quotes-7b07e381.css')}}">
@endsection
@section('content')
               ...
               <div ng-if="responsiveIfVisible" class="ng-scope">
                 ...
                 <div class="WorkInbox">
                   <ul class="ContentList">
                       @foreach($sentQuotesData as $data) 
                      <a href="" class="WorkItem Request is-unread ContentList-item ContentList-item-rightColumn ng-isolate-scope" type="submit">
                         ...
                         <div class="ContentList-item-column">
                            ...
                            <span class="WorkItem-categoryAndLocation">  {{$data->serviceName}}
                            </span>
                         ...
                         <div class="ContentList-item-column">
                            ...
                            <div class="WorkItem-actionDecline1 Request-actionDecline1 ">
                               <span class="pseudo-link"><h2>${{$data->quotesPrice}}</h2></span>
                            </div>
                         </div>
                      </a>
                      @endforeach
...
@endsection
@section('javascript')
<script type="text/javascript" src="{{URL::to('public/assets/pa-active-quote-page-ng.es6-2f45a194.js')}}"></script>
