    ...
    <div class="card">
        <div class="card-header" data-background-color="orange">
            ...
            <div style="padding-right: 15px;" class="text-right">
                <a href="{{ URL::to('newProfessionalUser') }}" class="btn btn-warning">Create New Professional User</a>
            </div>
            ...
            <div class="card-content table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$posts->mobile}}</td>
                        <td>
                             <a href="editProfessionalUser{{$posts->id}}" type="button" rel="tooltip" class="btn btn-success btn-xs" data-original-title="" title="Edit">
                            <i class="material-icons">edit</i>
                            <div class="ripple-container"></div></a>
                        </td>
                        <td>
                             <a href="deleteProfessionalUser{{$posts->id}}" type="button" rel="tooltip" class="btn btn-danger btn-xs" data-original-title="" title="Delete" onclick="return ConfirmDelete()">
