    ...
    <div class="card">
        <div class="card-header" data-background-color="orange">
            ...
            <div style="padding-right: 15px;" class="text-right">
                <a href="{{ URL::to('newAdminBySuperAdmin') }}" class="btn btn-warning">Create New Admin</a>
            </div>
            ...
            <div class="card-content table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$posts->mobile}}</td>
                        <td>
                             <a href="editAdminBySuperAdmin{{$posts->id}}" type="button" rel="tooltip" class="btn btn-success btn-xs" data-original-title="" title="Edit">
                            <i class="material-icons">edit</i>
                            <div class="ripple-container"></div></a>
                        </td>
                        @if (!auth()->user()->isAdmin())
                        <td>
                             <a href="deleteAdminBySuperAdmin{{$posts->id}}" type="button" rel="tooltip" class="btn btn-danger btn-xs" data-original-title="" title="Delete" onclick="return ConfirmDelete()">
