    ...
    <div class="card">
        <div class="card-header" data-background-color="orange">
            ...
            <div style="padding-right: 15px;" class="text-right">
                <a href="{{ URL::to('newAdmin') }}" class="btn btn-warning">Create New Admin</a>
            </div>
            ...
            <div class="card-content table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$posts->mobile}}</td>
                        <td>
                             <a href="editAdmin{{$posts->id}}" type="button" rel="tooltip" class="btn btn-success btn-xs" data-original-title="" title="Edit">
