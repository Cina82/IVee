                           ...
                           @foreach($homeImprovement as $hmt)
                                 ...
                                 <div class="column-lg-2" >
                                    <div class="ServiceBox-container">
                                       <a class="ServiceBox-item" onclick="customerQuestion({{$hmt->id}})" style="text-decoration: none;">
                                          <div
                              ...
                              @endphp
                                    <div class='wizard-step' data-title='{{$hmt->name}}'>
                                      {{csrf_field()}}
                                       <input type="hidden" name="serviceId" value="{{$hmt->id}}">
