    ...
    <div class="card">
        <div class="card-header" data-background-color="orange">
            ...
            <div style="padding-right: 15px;" class="text-right">
                <a href="<?php echo e(URL::to('newService')); ?>" class="btn btn-info">Create New Service</a>
            </div>
            ...
            <div class="card-content table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($posts->image); ?></td>
                        <td>
                             <a href="editService<?php echo e($posts->id); ?>" type="button" rel="tooltip" class="btn btn-success btn-xs" data-original-title="" title="Edit">
                            <i class="material-icons">edit</i>
                            <div class="ripple-container"></div></a>
                        </td>
                        <td>
                             <a href="deleteService<?php echo e($posts->id); ?>" type="button" rel="tooltip" class="btn btn-danger btn-xs" data-original-title="" title="Delete" onclick="return ConfirmDelete()">
