...
<hero
   ...
   uses-densities
   above-md="{
   '1x': '  <?php echo e(URL::to('public/assets/img/home-dd5692cb.jpg')); ?>

   ',
   '2x': '  <?php echo e(URL::to('public/assets/img/home-dd5692cb.jpg')); ?>
                           ...
                           <?php $__currentLoopData = $homeImprovement; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hmt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                 ...
                                 <div class="column-lg-2" >
                                    <div class="ServiceBox-container">
                                       <a class="ServiceBox-item" onclick="customerQuestion(<?php echo e($hmt->id); ?>)" style="text-decoration: none;">
                                          <div
                                             class="ServiceBox-item-image"
                                             lazy-image
                                             lazy-image-src="<?php echo e(URL::to('public/uploads')); ?>/<?php echo e($hmt->image); ?>" class="ServiceBox-item-image"
                                             >
                              ...
                              <?php  
                                 ...
                                 $questionDecode = json_decode($hmt->question);
                              ...
                              <?php 
                               ...
                               ?>
                                    <div class='wizard-step' data-title='<?php echo e($hmt->name); ?>'>
                                      <?php echo e(csrf_field()); ?>

                                       <input type="hidden" name="serviceId" value="<?php echo e($hmt->id); ?>">
