            ...
            <ul class="full-footer__legal__docs">
               <li class="full-footer__legal__docs__item">
                  <a class="full-footer__legal__docs__link"
                     href="<?php echo e(URL::to('privacy')); ?>">
                  Privacy Policy
                  </a>
               </li>
               <li class="full-footer__legal__docs__item">
                  <a class="full-footer__legal__docs__link"
                     href="<?php echo e(URL::to('terms')); ?>">
                  Terms of Use
                  </a>
               </li>
            </ul>
               ...
               <div class="full-footer__item is-collapsed"
                  ...
                  <div class="full-footer__item__links">
                     <ul dir="rtl">
                        ...
                        <li>
                           <a href="<?php echo e(URL::to('jobs')); ?>"
                              class="full-footer__item__link">
                           Jobs
                           </a>
                        </li>
                        <li>
                           <a href="<?php echo e(URL::to('team')); ?>"
                              class="full-footer__item__link">
                           Team
                           </a>
                        </li>
                        <li>
                           <a href="<?php echo e(URL::to('blog')); ?>"
                              class="full-footer__item__link">
                           Blog
                           </a>
                        </li>
            ...
            <div class="tp-col tp-col--12 tp-col--lg-2">
               <div class="full-footer__item is-collapsed"
                  ...
                  <div class="full-footer__item__links">
                     <ul dir="rtl">
                        <li>
                           <a href="<?php echo e(URL::to('howItWorks')); ?>"
                              class="full-footer__item__link">
                           How it works
                           </a>
                        </li>
                        <li>
                           <a href="<?php echo e(URL::to('safety')); ?>"
                              class="full-footer__item__link">
                           Safety
                           </a>
                        </li>
                        ...
                        <!-- <li>
                           <a href="<?php echo e(URL::to('nearMe')); ?>"
                              class="full-footer__item__link">
                           Services Near Me
                           </a>
                        </li> -->
                        <li>
                           <a href="<?php echo e(URL::to('prices')); ?>"
                              class="full-footer__item__link">
                           Cost Estimates
                           </a>
                        </li> 
                        <li>
                           <a href="<?php echo e(URL::to('serviceGuides')); ?>"
                              class="full-footer__item__link">
                           Service Guides
                           </a>
                        </li>
                        <li>
                           <a href="<?php echo e(URL::to('howTo')); ?>"
                              class="full-footer__item__link">
                           How To Pages
                           </a>
                        </li>
               ...
               <div class="full-footer__item is-collapsed"
                  ...
                  <div class="full-footer__item__links">
                     <ul dir="rtl">
                        ...
                        <li>
                           <a href="<?php echo e(URL::to('proCenter')); ?>" class="full-footer__item__link">
                           Pro center
                           </a>
                        </li>
                        <li>
                           <a href="<?php echo e(URL::to('stories')); ?>"
                              class="full-footer__item__link">
                           Success stories
                           </a>
                        </li>
                        <li>
                           <a href="<?php echo e(URL::to('proApp')); ?>"
                              class="full-footer__item__link">
                           Mobile app
                           </a>
                        </li>
