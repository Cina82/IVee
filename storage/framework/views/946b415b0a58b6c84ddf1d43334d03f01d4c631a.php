 ...
 <div class="col-md-12">
    ...
    <div class="card">
        <div class="card-header" data-background-color="orange">
            <h4 class="title">Edit Organiser</h4>
        </div>
        <div class="card-content">
	        <form method="post" action="editOrganiser">
	            ...
	            <div class="row">
	                ...
	                <div class="col-md-6"> 
					    <div class="form-group">
						   ...
						   <input class="form-control" type="text" name="noManagerCreate" id="noManagerCreate" value="<?php echo e($post->noManagerCreate); ?>">
						   <span class="material-input"></span></div>
	                   </div>
	                   <div class="col-md-6"> 
					    <div class="form-group">
						   <label class="control-label">Number of Parking Create</label>
						   <input class="form-control" type="text" name="noParkingCreate" id="noParkingCreate" value="<?php echo e($post->noParkingCreate); ?>">
						   <span class="material-input"></span></div>
	                   </div>
	                </div>
