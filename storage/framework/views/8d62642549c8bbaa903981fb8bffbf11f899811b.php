                            ...
                            <div class="tp-grid">
                              ...
                              <?php echo $__env->make('howThumbtackNav.howThumbtackNav', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                ...
                                <div class="main-content__content tp-col tp-col--12 tp-col--md-8" itemscope="" itemtype="https://schema.org/CreativeWork">
                                    ...
                                    <div class="intro-content">
                                        <div class="intro-content__container tp-grid tp-grid--middle">
                                            <div class="intro-content__title-container tp-col tp-col--8">
                                                <h2 class="intro-content__title">Send a great follow-up message to seal the deal.</h2>
                                            </div>
                                    ...
                                    <h2 class="subsection_title tp-heading-4">Follow-up messages to get you hired</h2>
                                                ...
                                                <div class="testimonial-carousel__items tp-col tp-col--12">
                                                    ...
                                                    <div class="testimonial-carousel__item">
                                                        ...
                                                        <div class="testimonial-carousel__pro">
                                                            ...
                                                            <div class="testimonial-carousel__pro-container">
                                                                <div class="testimonial-carousel__pro-name">Elijah Bowie</div>

                                                                <div class="testimonial-carousel__pro-profession">Personal Training</div>
                                                                ...
                                                                <div class="testimonial-carousel__pro-link-container">
                                                                    <a href="#" target="_blank" class="testimonial-carousel__pro-link">See Elijah’s full interview&nbsp;»</a>
                                                                </div>
                                                    ...
                                                    <div class="testimonial-carousel__item">
                                                        ...
                                                        <div class="testimonial-carousel__pro">
                                                            ...
                                                            <div class="testimonial-carousel__pro-container">
                                                                <div class="testimonial-carousel__pro-name">Bill Howard</div>
                                                                ...
                                                                <div class="testimonial-carousel__pro-link-container">
                                                                    <a href="#" target="_blank" class="testimonial-carousel__pro-link">See Bill’s full interview&nbsp;»</a>
                                                                </div>
                                                    ...
                                                    <div class="testimonial-carousel__item">
                                                        ...
                                                        <div class="testimonial-carousel__pro">
                                                            ...
                                                            <div class="testimonial-carousel__pro-container">
                                                                <div class="testimonial-carousel__pro-name">Jonathan Johnson</div>

                                                                <div class="testimonial-carousel__pro-profession">Photo Booth Rental Services</div>

                                                                <div class="testimonial-carousel__pro-stars-container">
                                                                    <img src="https://www.thumbtack.com/pro-center/wp-content/themes/procenter/images/stars.svg" width="72" height="12" style="width:72px;height:12px;"><span class="testimonial-carousel__pro-reviews"> (95 reviews)</span>
                                                                </div>

                                                                <div class="testimonial-carousel__pro-link-container">
                                                                    <a href="#" target="_blank" class="testimonial-carousel__pro-link">See Jonathan’s full interview&nbsp;»</a>
                                                                </div>
                    ...
                    <div class="tp-grid">
                        <div class="footer-block__container tp-col tp-col--12 tp-col--md-8 tp-col--md-offset-4 ">
                            <div class="footer-block__content">
                                <span class="footer-block__title">Next article: You’re hired</span>
