 ...
 <div class="background">
    ...
    <use xlink:href="#thumbprinticon-search_16"></use>
            ...
            <quote-list class="WorkInbox ng-isolate-scope">
                                ...
                                <svg-icon type="work--empty_states_icons--empty_hired_icon" size="lg" class="ng-scope theme-large IconContainer"><svg class="Icon" viewBox="0 0 48 48">
    <use xlink:href="#thumbprinticon-work--empty_states_icons--empty_hired_icon_48"></use>
</svg>
</svg-icon>
                            </div>
                            <div class="EmptyState-message">
                                The jobs you've been hired for will show up here.
                            </div>
                                            </div>
                            </quote-list>
        </div>
