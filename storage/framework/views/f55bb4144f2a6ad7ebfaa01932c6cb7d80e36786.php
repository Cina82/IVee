...
<link rel="stylesheet" href="<?php echo e(URL::to('public/assets/style.css')); ?>"/>
<link rel="stylesheet" href="<?php echo e(URL::to('public/assets/procss.css')); ?>" />
<link rel="stylesheet" href="<?php echo e(URL::to('public/assets/default.min.css')); ?>"/>
<link rel="stylesheet" href="<?php echo e(URL::to('public/assets/modaal.css')); ?>"/>
<script src="<?php echo e(URL::to('public/assets/jquery.js')); ?>"></script>
<script src="<?php echo e(URL::to('public/assets/jquery-migrate.min.js')); ?>"></script>

<?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
 </div>
                <nav class="tp-col tp-col--12 tp-col--md-4 static-header__nav">
                    <ul id="menu-get-hired-guide" class="static-header__navlist">
                        <li id="menu-item-18851" class="show-in-header-only tp-display--none--small tp-display--none--medium menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-18851"><a href="https://www.thumbtack.com/pro-center/" itemprop="url"></a></li>
                        <li id="menu-item-18852" class="show-in-header-only tp-display--none--small tp-display--none--medium menu-item menu-item-type-custom menu-item-object-custom menu-item-18852"><a href="https://www.thumbtack.com/profile/work/leads/" itemprop="url"></a></li>
                        <li id="menu-item-19114" class="static-header__navlist--mobile-only menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-18841 current_page_item menu-item-19114"><a href="index.html" itemprop="url">How Thumbtack works</a></li>
                        <li id="menu-item-19113" class="static-header__navlist--mobile-only menu-item menu-item-type-post_type menu-item-object-page menu-item-19113"><a href="<?php echo e(URL::to('proCenter/get-hired-guide/profile')); ?>" itemprop="url">Build your profile</a></li>
                        <li id="menu-item-19112" class="static-header__navlist--mobile-only menu-item menu-item-type-post_type menu-item-object-page menu-item-19112"><a href="https://www.thumbtack.com/pro-center/get-hired-guide/reviews/" itemprop="url">Get reviews</a></li>
                        <li id="menu-item-19111" class="static-header__navlist--mobile-only menu-item menu-item-type-post_type menu-item-object-page menu-item-19111"><a href="https://www.thumbtack.com/pro-center/get-hired-guide/preferences/" itemprop="url">Set your preferences</a></li>
                        <li id="menu-item-19110" class="static-header__navlist--mobile-only menu-item menu-item-type-post_type menu-item-object-page menu-item-19110"><a href="https://www.thumbtack.com/pro-center/get-hired-guide/quotes/" itemprop="url">Send a winning quote</a></li>
                        <li id="menu-item-19109" class="static-header__navlist--mobile-only menu-item menu-item-type-post_type menu-item-object-page menu-item-19109"><a href="https://www.thumbtack.com/pro-center/get-hired-guide/followup/" itemprop="url">Follow up</a></li>
                        <li id="menu-item-19108" class="static-header__navlist--mobile-only menu-item menu-item-type-post_type menu-item-object-page menu-item-19108"><a href="https://www.thumbtack.com/pro-center/get-hired-guide/hired/" itemprop="url">You&#8217;re hired</a></li>
                    </ul>
                </nav>
            </div>
        </div>
                    ...
                    <div class="main-content ghg__child">
                        <div class="main-content__wrapper tp-wrap">
                            <div class="tp-grid">
                               ...
                               <?php echo $__env->make('howThumbtackNav.howThumbtackNav', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<script src="<?php echo e(URL::to('public/assets/superfish.js')); ?>"></script>
<script src="<?php echo e(URL::to('public/assets/procenter-ga.js')); ?>"></script>
<script src="<?php echo e(URL::to('public/assets/slick.min.js')); ?>"></script>
<script src="<?php echo e(URL::to('public/assets/get-hired-guide.js')); ?>"></script>
