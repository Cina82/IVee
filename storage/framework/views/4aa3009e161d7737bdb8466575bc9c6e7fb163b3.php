...
<hero
   ...
   uses-densities
   above-md="{
   '1x': ' <?php echo e(URL::to('public/assets/img/events-f8c5e558.jpg')); ?>

   ',
   '2x': ' <?php echo e(URL::to('public/assets/img/events-f8c5e558.jpg')); ?>
                           ...
                           <?php $__currentLoopData = $event; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $evt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                               ...
                               <div class="column-lg-2" >
                                    <div class="ServiceBox-container">
                                       <a class="ServiceBox-item" onclick="customerQuestion(<?php echo e($evt->id); ?>)" style="text-decoration: none;">
                                          <div
                                             class="ServiceBox-item-image"
                                             lazy-image
                                             lazy-image-src="<?php echo e(URL::to('public/uploads')); ?>/<?php echo e($evt->image); ?>" class="ServiceBox-item-image"
                                             >
                              ...
                              <?php  
                               ...
                               ?>
                                 <div class="wizard" id="wizard<?php echo e($evt->id); ?>">
      ...
      <div class="column-lg-6 MoreServices-column">
         ...
         <div class="MoreServices-service">
            ...
            <ul>
                 <?php $__currentLoopData = $event; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $evt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <li>
                     <a class="B2-S theme-secondary MoreServices-service-link" onclick="customerQuestion(<?php echo e($evt->id); ?>)" style="text-decoration: none;">
                                 <?php echo e($evt->name); ?> 
                     </a>
                  </li>
               <?php  
