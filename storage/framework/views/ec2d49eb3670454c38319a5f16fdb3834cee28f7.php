...
<link rel="stylesheet" href="<?php echo e(URL::to('public/assets/styles.css')); ?>" />
...
<link rel="stylesheet" href="<?php echo e(URL::to('public/assets/st1.css')); ?>" />
 <style type="text/css">
        img.wp-smiley,
        img.emoji {
 ...
 <script type="text/javascript" src="<?php echo e(URL::to('public/assets/jquery1.1.js')); ?>"></script>
                        ...
                        <div class="tp-wrap">
                            <div class="tp-grid tp-grid--middle">
                                <div class="tp-col tp-col--12 tp-col--md-5" dir="rtl">
                                    ...
                                    <p class="tp-text-3--static tp-color--muted map__subtitle-large tp-display--block--large tp-display--block--large-plus"> Not a Thumbtack pro yet? <a href="<?php echo e(URL::to('choose-account')); ?>" class="tp-link--underline tp-link--muted">Sign up.</a></p>
                                </div>
                                    ...
                                    <div class="tp-grid">
                                        <div class="tp-col tp-col--12">
                                            <div class="tp-button-row tp-button-row--center">
                                                ...
                                                <a href="<?php echo e(URL::to('stories')); ?>" class="tp-button tp-button--large tp-button--tertiary pro-tips__cta">See all stories</a> </div>
                                        </div>
                                    </div>
                                </div>
...
<script src="<?php echo e(URL::to('public/assets/procenter-signal.js')); ?>"></script>
