    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <?php if (Auth::check() && Auth::user()->hasRole('admin')): ?>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li <?php echo e(Request::is('users', 'users/' . Auth::user()->id, 'users/' . Auth::user()->id . '/edit') ? 'class=active' : null); ?>><?php echo HTML::link(url('/users'), 
                            Lang::get('titles.adminUserList')); ?></li>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <?php if(Auth::guest()): ?>
                   <li><a href="<?php echo e(route('login')); ?>"><?php echo trans('Log In'); ?></a></li>
                    <!-- <li><a href="<?php echo e(route('register')); ?>"><?php echo trans('Sign Up'); ?></a> -->
                    <!-- <li><a href="choose-account"><?php echo trans('Sign Up'); ?></a>
                    </li>
 -->
                <?php else: ?>
                    <li class="dropdown">
                        <a href="logout" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
