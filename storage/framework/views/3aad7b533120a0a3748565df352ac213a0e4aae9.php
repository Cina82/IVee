...
<!-- Banner
================================================== -->
<div id="banner" style="background-image: url(<?php echo e(URL::to('frontend/images/banner-home-01.jpg')); ?>)" class="parallax background" data-img-width="2000" data-img-height="1330" data-diff="400">
    <div class="container">
        <div class="sixteen columns">
            ...
            <div class="search-container">
                ...
                <div class="browse-jobs">
                    Browse job offers by <a href="browse-categories.html"> category</a> or <a href="index-2.html#">location</a>
                </div>
...
<div class="container">
    <div class="sixteen columns">
        ...
        <ul id="popular-categories">
            <li><a href="index.html#"><i class="ln  ln-icon-Bar-Chart"></i> Accounting / Finance</a></li>
            <li><a href="index.html#"><i class="ln ln-icon-Car"></i> Automotive Jobs</a></li>
            <li><a href="index.html#"><i class="ln ln-icon-Worker"></i> Construction / Facilities</a></li>
            <li><a href="index.html#"><i class="ln ln-icon-Student-Female"></i> Education Training</a></li>
            <li><a href="index.html#"><i class="ln  ln-icon-Medical-Sign"></i> Healthcare</a></li>
            <li><a href="index.html#"><i class="ln  ln-icon-Plates"></i> Restaurant / Food Service</a></li>
            <li><a href="index.html#"><i class="ln  ln-icon-Globe"></i> Transportation / Logistics</a></li>
            <li><a href="index.html#"><i class="ln  ln-icon-Laptop-3"></i> Telecommunications</a></li>
        </ul>
    ...
    <div class="padding-right">
        ...
        <ul class="job-list">
            ...
            <li class="highlighted"><a href="job-page.html">
                <img src="<?php echo e(URL::to('frontend/images/job-list-logo-01.png')); ?>" alt="">
            ...
            <li><a href="job-page.html">
                <img src="<?php echo e(URL::to('frontend/images/job-list-logo-02.png')); ?>" alt="">
                <div class="job-list-content">
            ...
            <li><a href="job-page.html">
                <img src="<?php echo e(URL::to('frontend/images/job-list-logo-03.png')); ?>" alt="">
                <div class="job-list-content">
            ...
            <li><a href="job-page.html">
                <img src="<?php echo e(URL::to('frontend/images/job-list-logo-04.png')); ?>" alt="">
                <div class="job-list-content">
            ...
            <li><a href="job-page.html">
                <img src="<?php echo e(URL::to('frontend/images/job-list-logo-05.png')); ?>" alt="">
                <div class="job-list-content">
                    ...
                    <ul>
                        ...
                        <li>
                            <div class="job-spotlight">
                                <a href="index.html#"><h4>Social Media: Advertising Coordinator <span class="part-time">Part-Time</span></h4></a>
                                <span><i class="fa fa-briefcase"></i> Mates</span>
                                <span><i class="fa fa-map-marker"></i> New York</span>
                        ...
                        <li>
                            <div class="job-spotlight">
                                <a href="index.html#"><h4>Prestashop / WooCommerce Product Listing <span class="freelance">Freelance</span></h4></a>
                                <span><i class="fa fa-briefcase"></i> King</span>
                                <span><i class="fa fa-map-marker"></i> London</span>
                        ...
                        <li>
                            <div class="job-spotlight">
                                <a href="index.html#"><h4>Logo Design <span class="freelance">Freelance</span></h4></a>
                                <span><i class="fa fa-briefcase"></i> Hexagon</span>
                                <span><i class="fa fa-map-marker"></i> Sydney</span>
...
<div class="container">
    ...
    <div class="one-third column">
        ...
        <div class="recent-post">
            ...
            <img src="<?php echo e(URL::to('frontend/images/recent-post-01.jpg')); ?>" alt=""></a><div class="hover-icon"></div></div>
            <a href="blog-single-post.html"><h4>Hey Job Seeker, It’s Time To Get Up And Get Hired</h4></a>
            <div class="meta-tags">
                <span>October 10, 2015</span>
                <span><a href="index.html#">0 Comments</a></span>
            </div>
    ...
    <div class="one-third column">
        ...
        <div class="recent-post">
            ...
            <img src="<?php echo e(URL::to('frontend/images/recent-post-02.jpg')); ?>" alt=""></a><div class="hover-icon"></div></div>
    ...
    <div class="one-third column">
        ...
        <div class="recent-post">
            <div class="recent-post-img"><a href="blog-single-post.html">
            <img src="<?php echo e(URL::to('frontend/images/recent-post-03.jpg')); ?>" alt=""></a><div class="hover-icon"></div></div>
