...
<link rel="stylesheet"
        href="<?php echo e(URL::to('public/assets/login-a8ada3b9.css')); ?>" />

    <link rel="stylesheet"
        href="<?php echo e(URL::to('public/assets/facebook-login-button-3bfabb7e.css')); ?>" />
...
<?php $__env->startSection('content'); ?>
  ...
  <login class="LoginWrap">
        <div class="Login">
            ...
            <form action="<?php echo e(URL::to('login')); ?>"
                method="POST"
                ...
                <div class="Login-secondaryElements">
                    ...
                    <input-checkbox input-checkbox-label="Remember me">
                     ...
                     <a class="tp-text-3--static" href="<?php echo e(URL::to('reset')); ?>"
                ...
                <div class="Login-facebookDisclaimer tp-text-3--static">
                    ...
                    <a href="<?php echo e(URL::to('choose-account')); ?>">Sign up.</a>
                </div>
                    </div>
    </login>
