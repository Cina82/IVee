    ...
    <div class="card">
        <div class="card-header" data-background-color="orange">
            ...
            <div style="padding-right: 15px;" class="text-right">
                <a href="<?php echo e(URL::to('newSubCategory')); ?>" class="btn btn-info">Create New SubCategory</a>
            </div>
            ...
            <div class="card-content table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                             <a href="editSubCategory<?php echo e($posts->id); ?>" type="button" rel="tooltip" class="btn btn-success btn-xs" data-original-title="" title="Edit">
                            <i class="material-icons">edit</i>
                            <div class="ripple-container"></div></a>
                        </td>
                        <td>
                             <a href="deleteSubCategory<?php echo e($posts->id); ?>" type="button" rel="tooltip" class="btn btn-danger btn-xs" data-original-title="" title="Delete" onclick="return ConfirmDelete()">
