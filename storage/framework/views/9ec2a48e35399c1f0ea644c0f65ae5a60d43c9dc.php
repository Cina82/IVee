    ...
    <div class="card">
        <div class="card-header" data-background-color="blue">
            ...
            <div style="padding-right: 15px;" class="text-right">
                <a href="<?php echo e(URL::to('newManager')); ?>" class="btn btn-info">Create New Manager</a>
            ...
            <div class="card-content table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="editManager<?php echo e($posts->id); ?>" class="btn btn-primary btn-simple btn-xs" rel="tooltip" title="Edit Manager"><i class="material-icons">edit</i>Edit</a></td>
                        <td><a href="deleteManager<?php echo e($posts->id); ?>" class="btn btn-primary btn-simple btn-xs" rel="tooltip" title="Delete Manager"><i class="material-icons">close</i>Delete</a></td>    
                    </tr>
